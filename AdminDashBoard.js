...
const AdminDashBoard = () => {
      ...
      <div>
        <ul className="nav  bg-light  text-dark">
          <li className="nav-item">
            <Link to={`/user/add/${user._id}`} className="nav-link text">
              <button className="btn btn-sm btn-success  text">
                Update my details
              </button>
            </Link>
          </li>
          ...
          <li className="nav-item">
            <Link to="/admin/categories" className="nav-link text">
              <button className="btn btn-sm btn-success  text">
                Manage Categories
              </button>
            </Link>
          ...
          <li className="nav-item">
            <Link to="/admin/products" className="nav-link text">
              {" "}
              <button className="btn btn-sm btn-success  text">
                Manage Product
              </button>
          ...
          <li className="nav-item">
            <Link to={`/admin/order/all/${user._id}`} className="nav-link text">
              {" "}
              <button className="btn btn-sm btn-success text">
                Check All Orders
              </button>
  ...
  return (
    <Base className="container bg-success p-4 mt-1 box">
